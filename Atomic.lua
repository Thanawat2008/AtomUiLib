do 
    local ui =  game:GetService("CoreGui"):FindFirstChild("Diamond") 
    if ui then
        ui:Destroy()
    end
end
...
function create:Win()
    ...
    UIGradient_PageTap.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 35, 138))}
